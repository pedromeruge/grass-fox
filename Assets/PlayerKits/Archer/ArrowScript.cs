...
public class ArrowScript : MonoBehaviour
{
    ...
    private SpEntity playerOwner; // pointer para o player que criou esta seta, para n o atingir
    private StoEntity arrowRoot;
    ...
    private void Awake()
    {
        ...
        this.arrowRoot = GetComponent<StoEntity>();
    }
